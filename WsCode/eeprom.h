...
#define ADDR_DATA_BITMASK_SHOOTER   2
/* addresses 3,4,5 reserved */

#define ADDR_SHOOTER_TOP_HI         6
#define ADDR_SHOOTER_TOP_LO         7
#define ADDR_SHOOTER_BOT_HI         8
#define ADDR_SHOOTER_BOT_LO         9
/*********** Wildstang EEPROM Addresses ***********/
